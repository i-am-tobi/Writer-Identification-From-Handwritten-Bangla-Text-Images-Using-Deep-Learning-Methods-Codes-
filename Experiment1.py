...
"""Experiment1.ipynb
   ...
   and we also have used validation set to validate the training accuracy
"""
...
model.save('Trial_Model_2')

!zip -r /content/Trial_Model_2.zip /content/Trial_Model_2

model.save_weights('Trial_Model_weights_2')
