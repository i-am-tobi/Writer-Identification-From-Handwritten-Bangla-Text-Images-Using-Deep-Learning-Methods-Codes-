...
"""Experiment2.ipynb
   ...
   In this code we have used LeakyRelu Activation Function to train the fully connected layers. 
...
#Saving the model
model.save('Model_Trial_3_No_Validation_LeakyReLU')

!zip -r /content/Model_Trial_3_No_Validation_LeakyReLU.zip /content/Model_Trial_3_No_Validation_LeakyReLU
